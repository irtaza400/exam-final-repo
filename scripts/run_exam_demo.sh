...
REQUIRED_FILES=(
    ...
    "src/simulated_ledger_status.py"
    "scripts/run_simulated_ledger_evidence.sh"
    "scripts/generate_fuxa_ledger_health_view.py"
    "scripts/import_fuxa_ledger_health_view.py"
    "scripts/validate_fuxa_ledger_health_view.py"
"scripts/generate_fuxa_operations_view.py"
"scripts/import_fuxa_operations_view.py"
"scripts/validate_fuxa_operations_view.py"
"fuxa/project/topic127_operations_overview.json"
    ...
    "scripts/generate_suricata_test_pcap.py"
...

{
    ...
    echo "  - Simulated blockchain valid, tampered and restored status evidence"
...
echo "  ls -lah reports/"
echo
echo "Supply-Chain/QMS and simulated blockchain evidence:"
...
echo "  python -m json.tool reports/simulated_ledger_status.json"
echo "  python -m json.tool reports/simulated_ledger_tamper_status.json"
echo "  python -m json.tool reports/simulated_ledger_restored_status.json"
echo "  cat reports/simulated_ledger_status.txt"
echo "  cat reports/simulated_ledger_tamper_status.txt"
echo "  cat reports/simulated_ledger_restored_status.txt"
echo
echo "FUXA ledger-health evidence:"
echo "  python scripts/validate_fuxa_ledger_health_view.py"
echo "  python -m json.tool reports/fuxa_ledger_health_validation.json"
echo "  cat logs/fuxa_ledger_health_generation.log"
echo "  cat logs/fuxa_ledger_health_import.log"
echo "  cat logs/fuxa_ledger_health_validation.log"
echo
echo "FUXA Operations Overview evidence:"
echo "  python scripts/validate_fuxa_operations_view.py"
echo "  python -m json.tool reports/fuxa_operations_overview_validation.json"
echo "  cat logs/fuxa_operations_generation.log"
echo "  cat logs/fuxa_operations_import.log"
echo "  cat logs/fuxa_operations_validation.log"
echo "  curl -s http://127.0.0.1:1881/api/project"
echo
echo "Suricata IDS evidence:"
echo "  cat suricata/logs/fast.log"
echo "  python -m json.tool reports/suricata_ids_validation.json"
echo "  cat reports/suricata_ids_final_evidence.txt"
echo
echo "Exam summary:"
